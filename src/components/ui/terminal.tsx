...
export function Terminal({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "mx-auto w-full max-w-xl font-mono text-xs",
        className
      )}
    >
      <div className="overflow-hidden rounded-lg border border-border bg-card shadow-lg">
        {/* Title Bar */}
        <div className="flex items-center gap-2 bg-surface-300 px-4 py-2">
        ...
        <div
          ref={contentRef}
          className="h-64 overflow-y-auto p-4 font-mono scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent"
        >
          {lines.map((line, i) => (
